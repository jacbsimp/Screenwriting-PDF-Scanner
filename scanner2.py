...
def iter_find(line, word, page):
    if line == word:
        print("FOUND---------------------")
        # specify out file
        f = open("./outputs/animals.txt", 'a')
        f.write("Pattern Found on Page: {}, {}\n".format(str(page), str(line)))
...
if __name__ == '__main__':
    ...
    with open(path, 'rb') as f:
        ...
        with open('./wordlists/animals.txt', 'r') as wordlist_vehicles:
